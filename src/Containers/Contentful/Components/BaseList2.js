import { Avatar, Box, Card, CardBody, CardHeader, Grid, Heading, Image, Stack, Text } from 'grommet';
import React from 'react';

const avatarSrc = '//s.gravatar.com/avatar/b7fb138d53ba0f573212ccce38a7c43b?s=80';

function BaseList2({ items }) {
  return (
    <Box pad="xxsmall" height="medium">
      <Grid gap="medium" rows="medium" columns={{ count: 'fit', size: ['small', 'medium'] }}>
        {items.map((item) => (
